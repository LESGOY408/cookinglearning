		 ...
		 <div class="list_info">
			 ...
			 <table class="regTable">
				...
				<tr>
					...
					<td align="left" width="80%"><input type="text" name="params.login_name" id="login_name" style="width:200px;" class="inputstyle"/></td>
				</tr>
				<tr>
					<td align="right" width="20%"><span style="color:red">*</span> 密　码：</td>
					<td align="left" width="80%"><input type="password" name="params.login_pass" id="login_pass" style="width:200px;" class="inputstyle"/></td>
				</tr>
				<tr>
					<td align="right" width="20%"><span style="color:red">*</span> 确认密码：</td>
					<td align="left" width="80%"><input type="password" name="params.user_rpass" id="user_rpass" style="width:200px;" class="inputstyle"/></td>
				</tr>
				<tr>
					<td align="right" width="20%"><span style="color:red">*</span> 昵　称：</td>
					<td align="left" width="80%"><input type="text" name="params.nick_name" id="nick_name" style="width:200px;" class="inputstyle"/></td>
				</tr>
				<tr>
					<td align="right" width="20%">姓　名：</td>
					<td align="left" width="80%"><input type="text" name="params.real_name" id="real_name" style="width:200px;" class="inputstyle"/></td>
				</tr>
				<tr>
					<td align="right" width="20%"><span style="color:red">*</span> 邮　箱：</td>
					<td align="left" width="80%"><input type="text" name="params.user_mail" id="user_mail" style="width:200px;" class="inputstyle"/></td>
				</tr>
				<tr>
					<td align="right" width="20%"><span style="color:red">*</span> 电　话：</td>
					<td align="left" width="80%"><input type="text" name="params.user_mobile" id="user_mobile" style="width:200px;" class="inputstyle"/></td>
				</tr>
				<tr>
					<td align="right" width="20%">地　址：</td>
					<td align="left" width="80%"><input type="text" name="params.user_lxdz" id="user_lxdz" style="width:200px;" class="inputstyle"/></td>
				</tr>
				<tr>
					<td align="right" width="20%"><span style="color:red">*</span> 验证码：</td>
					<td align="left" width="80%"> 
						<input type="text" id="random" name="params.random" style="width:80px;" class="inputstyle"/>
...
$(document).ready(function(){
	...
	addBtn.bind("click",function(){
		...
		if(login_pass.val()!=user_rpass.val()){
			alert("两次输入密码不一致");
			return;
		}
		if(nick_name.val()==''){
