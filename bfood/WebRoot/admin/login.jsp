				...
				<TR>
					...
					<TBODY>
						<TR>
							...
							<TD style="HEIGHT: 28px" width=150><INPUT id="params.login_name" name="params.login_name" value="${params.login_name}" style="WIDTH: 130px" name=txtName></TD>
						...
						<TR>
							...
							<TD style="HEIGHT: 28px"><INPUT id="params.Login_pass" name="params.Login_pass"   style="WIDTH: 130px" 
							  type="password"></TD>
...
<script language="javascript" type="text/javascript">
	...
	$(document).ready(function(){
		...
		var Login_pass = $("#params\\.Login_pass");
		var random = $("#params\\.random");
		var loginTip = $("#loginTip");
		
		loginInBtn.bind('click',function(){
			if(login_name.val()==''||Login_pass.val()==''||random.val()==''){
