...
<style type="text/css">
.left{width:190px; height:280px; background-color:#57529B}
...
<table width="190" border="0" cellspacing="0" cellpadding="0" height="100%">
  <tr>
  	<td height="23" style="text-align:center; line-height:23px; color:white; background-color:#57529B;font-weight:bold">功能模块管理</td>
  </tr>
  <tr>
			 ...
			 <table width="100%" height="280" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEF2FB">
			  <tr>
				...
				<div id="container">
				  ...
				  <h1 class="type"><a href="javascript:void(0)">菜谱类别管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listFoodTypes.action" target="MainFrame">菜谱类别查询</a></li>
					  <li><a href="Admin_addFoodTypeShow.action" target="MainFrame">新增菜谱类别</a></li>
					</ul>
				  </div>
				  <h1 class="type"><a href="javascript:void(0)">菜谱信息管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listFoods.action" target="MainFrame">菜谱查询</a></li>
					</ul>
				  </div>
				  </c:if>
