...
function del()
{
    ...
    if(confirm('确认删除吗!?'))
    {
       document.info.action="Admin_delFoods.action?paramsFood.ids="+ids;
       document.info.submit();
    }
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">菜谱管理&gt;&gt;菜谱查询</span>
</div>
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="<s:if test='(#status.index + 1)%2==0'>list1</s:if><s:else>list0</s:else>" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     <td width="" align="center"><s:checkbox name="chkid" fieldValue="%{#food.food_id}" cssStyle="vertical-align:text-bottom;"/></td>
     <td width="" align="center"><s:property value="#status.index+1"/></td>
     <td width="" align="center"><s:property value="#food.food_name"/></td>
     ...
     <td width="" align="center">
       <s:a href="Admin_queryFood.action?paramsFood.food_id=%{#food.food_id}">查看</s:a>&nbsp;
       <s:a href="Admin_editFood.action?paramsFood.food_id=%{#food.food_id}">编辑</s:a>
       <br/><s:a href="Admin_listSblogs.action?paramsSblog.food_id=%{#food.food_id}">评论管理</s:a>
     </td>
   </tr> 
   </s:iterator>
   </s:if>
   <s:else>
   <tr>
     <td height="60" colspan="13" align="center"><b>&lt;不存在菜谱信息&gt;</b></td>
   </tr>
   </s:else>
