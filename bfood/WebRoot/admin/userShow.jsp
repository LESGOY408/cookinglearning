...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">注册用户管理&gt;&gt;注册用户查询</span>
</div>
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="" align="right">
            用户名：
      <input type="text" id="paramsUser.login_name" name="paramsUser.login_name" value="${paramsUser.login_name}" class="inputstyle"/>&nbsp;
            姓名：
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="<s:if test='(#status.index + 1)%2==0'>list1</s:if><s:else>list0</s:else>" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center"><s:property value="#user.login_name"/></td>
     ...
     <td width="" align="center"><s:property value="#user.user_mobile"/>&nbsp;</td>
     <td width="" align="center"><s:property value="#user.user_lxdz"/>&nbsp;</td>
     <td width="" align="center"><s:property value="#user.add_date.substring(0,19)"/>&nbsp;</td>
   ...
   <s:else>
   <tr>
     <td height="60" colspan="14" align="center"><b>&lt;不存在注册用户信息&gt;</b></td>
   </tr>
   </s:else>
