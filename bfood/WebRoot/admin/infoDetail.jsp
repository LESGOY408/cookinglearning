...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">图书章节管理&gt;&gt;查询图书章节</span>
</div>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
        ...
        <tr>
          <td align="center" style="padding-right:5px">
          	章节字数：<s:property value="%{#attr.info.info_words}"/>个&nbsp;
          	发布时间：<s:property value="%{#attr.info.info_date.substring(0,19)}"/> 
          </td>
        </tr> 
        <tr> 
          <td align="left" style="padding:5px;line-height:22px"><s:property value="#attr.info.info_contentShow" escape="false"/></td>
        </tr>   
     </table>  
     </td> 
   </tr>   
